...
const elements = {
  ...
  sideChatBtn: document.getElementById('sideChatBtn'),
  sideChatBtnLabel: document.getElementById('sideChatBtnLabel'),
  sideChatBanner: document.getElementById('sideChatBanner'),
  sideParentStatus: document.getElementById('sideParentStatus'),
