...
const elements = {
  ...
  widgetsToggleBtn: document.getElementById('widgetsToggleBtn'),
  widgetsCount: document.getElementById('widgetsCount'),
  widgetsBody: document.getElementById('widgetsBody'),
  widgetsList: document.getElementById('widgetsList'),
  widgetsMoreBtn: document.getElementById('widgetsMoreBtn'),
