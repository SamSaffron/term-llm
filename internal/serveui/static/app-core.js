...
const state = {
  ...
  sideQuestion: { visible: false, running: false, question: '', response: '', error: '', usage: {}, totalUsage: {}, requests: 0, history: [], generation: 0 },
  compressing: false,
  autoScroll: true,
  authRequired: false,
  connected: false,
...
const elements = {
  ...
  approvalIntro: document.getElementById('approvalIntro'),
