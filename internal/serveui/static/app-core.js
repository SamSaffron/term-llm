...
const state = {
  ...
  showWidgetsSidebar: localStorage.getItem(STORAGE_KEYS.showWidgetsSidebar) !== '0',
  ...
  sideQuestion: { visible: false, running: false, question: '', response: '', error: '', usage: {}, history: [], selected: -1, generation: 0 },
  autoScroll: true,
  authRequired: false,
  connected: false,
  attachments: [],
...
const elements = {
  ...
  headerTitleRow: document.querySelector('.header-title-row'),
  ...
  sideQuestionOverlay: document.getElementById('sideQuestionOverlay'),
  sideQuestionStatus: document.getElementById('sideQuestionStatus'),
  sideQuestionMainAttention: document.getElementById('sideQuestionMainAttention'),
  sideQuestionTranscript: document.getElementById('sideQuestionTranscript'),
  sideQuestionError: document.getElementById('sideQuestionError'),
  sideQuestionComposer: document.getElementById('sideQuestionComposer'),
  sideQuestionInput: document.getElementById('sideQuestionInput'),
  sideQuestionSendBtn: document.getElementById('sideQuestionSendBtn'),
  sideQuestionCloseBtn: document.getElementById('sideQuestionCloseBtn'),
  sideQuestionCopyBtn: document.getElementById('sideQuestionCopyBtn'),
  sideQuestionClearBtn: document.getElementById('sideQuestionClearBtn'),
  sideQuestionCancelBtn: document.getElementById('sideQuestionCancelBtn'),
  ...
  renameSessionIntro: document.getElementById('renameSessionIntro'),
  renameSessionNameField: document.getElementById('renameSessionNameField'),
  renameSessionInput: document.getElementById('renameSessionInput'),
  renameGeneratedFields: document.getElementById('renameGeneratedFields'),
  renameGeneratedTitleInput: document.getElementById('renameGeneratedTitleInput'),
  renameGeneratedDetailInput: document.getElementById('renameGeneratedDetailInput'),
  renameImproveTitleBtn: document.getElementById('renameImproveTitleBtn'),
  ...
  showWidgetsSidebarInput: document.getElementById('showWidgetsSidebarInput'),
  ...
  addLocationOption: document.getElementById('addLocationOption'),
  ...
  chipWorktree: document.getElementById('chipWorktree'),
  ...
  reasoningModeSelect: document.getElementById('reasoningModeSelect'),
  reasoningModeField: document.getElementById('reasoningModeField'),
...
const sanitizeSession = (session) => {
  ...
  const result = {
    ...
    activeReasoningMode: typeof session.activeReasoningMode === 'string' ? session.activeReasoningMode : '',
