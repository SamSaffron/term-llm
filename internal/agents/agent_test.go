...
func TestAgent_ShouldLoadProjectInstructions(t *testing.T) {
	tests := []struct {
		...
		{
			name: "agents_md true without coding tools",
			agent: Agent{
				Name:     "custom",
				AgentsMd: "true",
		...
		{
			name: "agents_md false with coding tools",
			agent: Agent{
				Name:     "artist",
				AgentsMd: "false",
