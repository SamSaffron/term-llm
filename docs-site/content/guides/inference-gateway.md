...
4. Provider resume state is opaque to satellites and authenticated with an AES-GCM gateway key. It is bound to both client ID and provider key; tampered or cross-client state is rejected.
